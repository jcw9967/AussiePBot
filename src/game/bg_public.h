...
#define CS_CLIENTS_READY    26    //following suggestion in STAT_ enum STAT_CLIENTS_READY becomes a configstring
...
typedef enum
{
  ...
  STAT_BOOSTTIME, //time left for boost (alien only)
...
#define SS_DOUBLEAMMO	        0x00006000
