...
vmCvar_t  g_ambush_stageLimit;
vmCvar_t  g_ambush_killsToNextStage;
vmCvar_t  g_ambush_timeToNextStage;
vmCvar_t  g_ambush_dodge;
vmCvar_t  g_ambush_rebuildTime;
vmCvar_t  g_ambush_secToStart;
vmCvar_t  g_ambush_stageSuicide;
vmCvar_t  g_ambush_noEggFFOff;
vmCvar_t  g_ambush_killSpawns;
vmCvar_t  g_ambush_attackBuildables;
vmCvar_t  g_ambush_range;
vmCvar_t  g_ambush_hbuildDmg;
vmCvar_t  g_ambush_abuildDmg;
...
//Custom Cvar
vmCvar_t  g_startwep;
vmCvar_t  g_starthelmet;
vmCvar_t  g_startlarmour;
vmCvar_t  g_startbattpack;
vmCvar_t  g_noblaster;
vmCvar_t  g_nomedkit;
...
static cvarTable_t   gameCvarTable[] =
{
  ...
  // change anytime vars
  { &g_maxGameClients, "g_maxGameClients", "14", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue  },
  { &g_timelimit, "timelimit", "999", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
  { &g_suddenDeathTime, "g_suddenDeathTime", "999", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_NORESTART, 0, qtrue },
  ...
  { &g_slapKnockback, "g_slapKnockback", "400", CVAR_ARCHIVE, 0, qfalse},
  ...
  { &g_popularMapsVotePercent, "g_popularMapsVotePercent", "50", CVAR_ARCHIVE  },

  { &g_warmup, "g_warmup", "0", CVAR_ARCHIVE, 0, qtrue  },
  { &g_warmupMode, "g_warmupMode", "0", CVAR_ARCHIVE, 0, qtrue  },
  ...
  { &g_speed, "g_speed", "350", CVAR_SERVERINFO, 0, qtrue  },
  ...
  { &g_mapvoteMaxTime, "g_mapvoteMaxTime", "59940", CVAR_ARCHIVE, 0, qfalse },
  ...
  { &g_pathediting, "g_pathediting", "1", CVAR_ARCHIVE, 0, qfalse },
  ...
  { &g_nobuildtimer, "g_nobuildtimer", "0", CVAR_ARCHIVE, 0, qfalse },
  ...
  { &g_teamImbalanceWarnings, "g_teamImbalanceWarnings", "0", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_floodMinTime, "g_floodMinTime", "1500", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_initialMapRotation, "g_initialMapRotation", "maprotation1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_shove, "g_shove", "15", CVAR_ARCHIVE, 0, qfalse  },
  { &g_mapConfigs, "g_mapConfigs", "mapconfig", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_adminMaxBan, "g_adminMaxBan", "7", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_decolourLogfiles, "g_decolourLogfiles", "1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_buildLogMaxLength, "g_buildLogMaxLength", "1000", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_antiSpawnBlock, "g_antiSpawnBlock", "1000", CVAR_ARCHIVE, 0, qfalse  },
  { &g_chat, "g_chat", "chat.dat", CVAR_ARCHIVE, 0, qfalse  },
  { &g_adminExpireTime, "g_adminExpireTime", "30", CVAR_ARCHIVE, 0, qfalse  },
  ...
  { &g_defaultLayout, "g_defaultLayout", "mjws", CVAR_ARCHIVE, 0, qtrue  },
  { &g_specNoclip, "g_specNoclip", "1", CVAR_ARCHIVE, 0, qtrue  },
  { &g_allowDevolve, "g_allowDevolve", "1", CVAR_ARCHIVE, 0, qtrue  },
  { &g_rankings, "g_rankings", "1", 0, 0, qfalse },
  ...
  { &g_ambush_timeToNextStage, "g_ambush_timeToNextStage", "120", CVAR_SERVERINFO | CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_dodge, "g_ambush_dodge", "1500", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_rebuildTime, "g_ambush_rebuildTime", "10", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_secToStart, "g_ambush_secToStart", "0", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_stageSuicide, "g_ambush_stageSuicide", "0", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_killSpawns, "g_ambush_killSpawns", "1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_attackBuildables, "g_ambush_attackBuildables", "1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_abuildDmg, "g_ambush_abuildDmg", "1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_hbuildDmg, "g_ambush_hbuildDmg", "1", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_range, "g_ambush_range", "7000", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_stageLimit, "g_ambush_stageLimit", "30", CVAR_ARCHIVE, 0, qfalse  },
  { &g_ambush_stage, "g_ambush_stage", "1", CVAR_ARCHIVE, 0, qfalse  },

  //Custom Cvar
  { &g_startwep, "g_startwep", "default", CVAR_ARCHIVE, 0, qfalse },
  { &g_starthelmet, "g_starthelmet", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_startlarmour, "g_startlarmour", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_startbattpack, "g_startbattpack", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_noblaster, "g_noblaster", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_nomedkit, "g_nomedkit", "0", CVAR_ARCHIVE, 0, qfalse },
  { &g_autoregister, "g_autoregister", "1", CVAR_ARCHIVE, 0, qfalse  },
};
...
void G_PathLoad( void )
{
	...
	len = trap_FS_FOpenFile( va( "paths/%s.dat", map ), &f, FS_READ );
	if( len < 0 )
	{
...
void G_InitGame( int levelTime, int randomSeed, int restart )
{
	...
	level.lastAmbushNextStageTime = level.time;
...
//reset if SD was on, but now it's off
	...
	if( !level.suddenDeath )
	{
		...
		else
		{
		  ...
		  //warn about sudden death
			...
			{
				AP(  va( "cp \"Sudden Death in %d seconds!\"", (int)( G_TimeTilSuddenDeath() / 1000 ) ) );
				level.suddenDeathWarning = TW_IMMINENT;
			}
		}
	}
  ...
  //set BP at each cycle
	...
	//may as well pump the stages here too
	{
		...
		if( level.averageNumAlienClients < 0.1f )
			level.averageNumAlienClients = 0.1f;

		if( level.averageNumHumanClients < 0.1f )
			level.averageNumHumanClients = 0.1f;

		if( g_alienStage.integer == S1 && g_alienMaxStage.integer > S1 )
			alienNextStageThreshold = (int)( ceil( (float)g_alienStage2Threshold.integer * level.averageNumAlienClients ) );
		else if( g_alienStage.integer == S2 && g_alienMaxStage.integer > S2 )
			alienNextStageThreshold = (int)( ceil( (float)g_alienStage3Threshold.integer * level.averageNumAlienClients ) );
		else
			alienNextStageThreshold = -1;

		if( g_humanStage.integer == S1 && g_humanMaxStage.integer > S1 )
			humanNextStageThreshold = (int)( ( g_ambush_stageLimit.integer / 3 ) * g_ambush_killsToNextStage.integer * level.numHumanClients );
		else if( g_humanStage.integer == S2 && g_humanMaxStage.integer > S2 )
			humanNextStageThreshold = (int)( ( ( 2 * g_ambush_stageLimit.integer ) / 3 ) * g_ambush_killsToNextStage.integer * level.numHumanClients );
		else
...
void G_CalculateStages( void )
{
	...
	int ambushStageLimit = g_ambush_stageLimit.integer;
	int ambushStage = g_ambush_stage.integer;
	...
	if( g_alienKills.integer >=
		(int)( ceil( (float)g_alienStage2Threshold.integer * level.averageNumAlienClients ) ) &&
	...
	if( g_alienKills.integer >=
		(int)( ceil( (float)g_alienStage3Threshold.integer * level.averageNumAlienClients ) ) &&
	...
	if( ambushStage == ( ambushStageLimit / 3 ) &&
	...
	if( ambushStage == ( ( 2 * ambushStageLimit ) / 3 ) &&
...
void CheckVote( void )
{
	...
	if( level.time - level.voteTime >= VOTE_TIME || ( level.voteYes + level.voteNo == ( level.numConnectedClients - 20 ) ) )
	{
	...
	AP(  va( "print \"Vote %s^7 (^2Y:%d^7-^1N:%d^7, %d percent) (%s)\n\"",
...
void CheckTeamVote( int team )
{
	...
	AP(  va( "print \"Team vote %s^7 (^2Y:%d^7-^1N:%d^7, %d percent)\n\"",
...
void G_RunFrame( int levelTime )
{
	...
	//if (g_ambush_stage.integer < 1){trap_Cvar_Set( "g_ambush_stage", "1");}
	//else if (g_ambush_stage.integer > 34){trap_Cvar_Set( "g_ambush_stage", "34");}
	G_UpdateCvars();
	//
	...
	if( g_ambush_timeToNextStage.integer > 0 )
	{		
		if( level.time >= level.lastAmbushNextStageTime + ( g_ambush_timeToNextStage.integer * 1000 ) )
		{
			ambush_next_stage();
		}
	}
