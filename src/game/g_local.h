...
//Custom Cvar
extern  vmCvar_t g_startwep;
extern  vmCvar_t g_starthelmet;
extern  vmCvar_t g_startlarmour;
extern  vmCvar_t g_startbattpack;
extern  vmCvar_t g_noblaster;
extern  vmCvar_t g_nomedkit;
