...
classAttributes_t bg_classList[ ] =
{
  ...
  },
  {
    ...
    { 15, 15, 22 },                                 //vec3_t  crouchmaxs;
    { -15, -15, -4 },                               //vec3_t  deadmins;
    { 15, 15, 4 },                                  //vec3_t  deadmaxs;
    -16.0f,                                         //float   zOffset
    0.f,                                            //float   spriteOffset;
    28, 12,                                         //int     viewheight, crouchviewheight;
    100,                                            //int     health;
    1.0f,                                           //float   fallDamage;
    4,                                              //int     regenRate;
...
weaponAttributes_t bg_weapons[ ] =
{
  ...
  {
    WP_MEDGUN,            //int       weaponNum;
    MEDGUN_PRICE,         //int       price;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    SLOT_WEAPON,          //int       slots;
    "medgun",             //char      *weaponName;
    "PortaMed",           //char      *weaponHumanName;
    MEDGUN_AMMO,          //int       maxAmmo;
    0,                    //int       maxClips;
    qfalse,               //int       infiniteAmmo;
    qtrue,                //int       usesEnergy;
    MEDGUN_REPEAT,        //int       repeatRate1;
    0,                    //int       repeatRate2;
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
  ...
  {
    WP_MINIGUN,          //int       weaponNum;
    MINIGUN_PRICE,       //int       price;
    ( 1 << S2 )|( 1 << S3 ), //int  stages
    SLOT_WEAPON,          //int       slots;
    "minigun",           //char      *weaponName;
    "Minigun",           //char      *weaponHumanName;
    MINIGUN_BULLETS,     //int       maxAmmo;
    0,                    //int       maxClips;
    qfalse,               //int       infiniteAmmo;
    qfalse,               //int       usesEnergy;
    MINIGUN_REPEAT,      //int       repeatRate1;
    0,                    //int       repeatRate2;
    0,                    //int       repeatRate3;
    0,                    //int       reloadTime;
    MINIGUN_K_SCALE,     //float     knockbackScale;
    qfalse,               //qboolean  hasAltMode;
    qfalse,               //qboolean  hasThirdMode;
    qfalse,               //qboolean  canZoom;
    90.0f,                //float     zoomFov;
...
void BG_PlayerStateToEntityState( playerState_t *ps, entityState_t *s, qboolean snap )
{
  ...
  // have to get the surfNormal thru somehow...
